...
tmux send -t mysession:1.6 "roslaunch vicon_sync vicon_commander_insoles.launch play_sound_after_calibration:=true" C-m
tmux send -t mysession:1.7 "roslaunch moticon_insoles onfeet_wrench.launch" C-m
